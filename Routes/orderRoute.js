const Order = require("../models/Order"); // Modèle de commande
const Cart = require("../models/Cart"); // Modèle de panier, si nécessaire
...
router.put("/order/:orderId", authMiddleware, orderController.updateOrderStatus);
